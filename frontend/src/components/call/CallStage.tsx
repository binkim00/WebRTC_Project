    ...
    >
      ...
      */}
      ...
      {reactionsOpen && reactionEmojis?.length && onReactionSend ? (
        <div
          aria-label={t('callStage.reactionGroup')}
          className="absolute right-3.5 top-[52px] z-20 flex items-center gap-1 rounded-full border border-white/10 bg-[rgb(15_17_21/62%)] px-2 py-1.5 backdrop-blur-md"
          role="group"
        >
