...
export const CARD_STICKER_CATEGORIES = (): readonly CardStickerCategory[] => [
  ...
  },
  {
    ...
    stickers: [
      ...
      { code: '1f4a2', name: translate('cardStickers.t212') },
      { code: '1f4a4', name: translate('cardStickers.t213') },
      { code: '1f4a8', name: translate('cardStickers.t214') },
      { code: '2734', name: translate('cardStickers.t215') },
      { code: '2733', name: translate('cardStickers.t216') },
      { code: '269c', name: translate('cardStickers.t217') },
    ],
  },
  {
    key: 'face',
  ...
  },
  {
    ...
    stickers: [
      ...
      { code: '1f4a3', name: translate('cardStickers.t218') },
      { code: '2049', name: translate('cardStickers.t219') },
      { code: '203c', name: translate('cardStickers.t220') },
      { code: '3030', name: translate('cardStickers.t221') },
      { code: '1f51d', name: translate('cardStickers.t222') },
      { code: '1f21a', name: translate('cardStickers.t223') },
    ],
  },
  {
    key: 'cute',
    ...
    stickers: [
      ...
      { code: '1f9b4', name: translate('cardStickers.t230') },
      { code: '1f43e', name: translate('cardStickers.t231') },
      { code: '1f954', name: translate('cardStickers.t232') },
      { code: '1f95a', name: translate('cardStickers.t233') },
      { code: '1f36f', name: translate('cardStickers.t234') },
      { code: '1f9c3', name: translate('cardStickers.t235') },
    ],
  },
  {
    key: 'party',
    ...
    stickers: [
      ...
      { code: '1f3aa', name: translate('cardStickers.t236') },
      { code: '1f9e8', name: translate('cardStickers.t237') },
      { code: '1f3c1', name: translate('cardStickers.t238') },
    ],
  },
  {
    key: 'music',
  ...
  },
  {
    ...
    stickers: [
      ...
      { code: '1f4bd', name: translate('cardStickers.t224') },
      { code: '1f4fc', name: translate('cardStickers.t225') },
      { code: '1f4e0', name: translate('cardStickers.t226') },
      { code: '1f4bb', name: translate('cardStickers.t227') },
      { code: '1f5a8', name: translate('cardStickers.t228') },
      { code: '1f4cd', name: translate('cardStickers.t229') },
    ],
  },
  {
    key: 'magic',
    label: translate('cardStickers.t239'),
    stickers: [
      { code: '1f52c', name: translate('cardStickers.t240') },
      { code: '1f9ff', name: translate('cardStickers.t241') },
      { code: '1f9e0', name: translate('cardStickers.t242') },
      { code: '1f4a1', name: translate('cardStickers.t243') },
      { code: '1f9ea', name: translate('cardStickers.t244') },
      { code: '1f9f2', name: translate('cardStickers.t245') },
      { code: '1f5dd', name: translate('cardStickers.t246') },
      { code: '1f52b', name: translate('cardStickers.t247') },
      { code: '1f6ce', name: translate('cardStickers.t248') },
      { code: '1f3b1', name: translate('cardStickers.t249') },
    ],
  },
  {
    key: 'zodiac',
    label: translate('cardStickers.t250'),
    stickers: [
      { code: '2648', name: translate('cardStickers.t251') },
      { code: '2649', name: translate('cardStickers.t252') },
      { code: '264a', name: translate('cardStickers.t253') },
      { code: '264b', name: translate('cardStickers.t254') },
      { code: '264c', name: translate('cardStickers.t255') },
      { code: '264d', name: translate('cardStickers.t256') },
      { code: '264e', name: translate('cardStickers.t257') },
      { code: '264f', name: translate('cardStickers.t258') },
      { code: '2650', name: translate('cardStickers.t259') },
      { code: '2651', name: translate('cardStickers.t260') },
      { code: '2652', name: translate('cardStickers.t261') },
      { code: '2653', name: translate('cardStickers.t262') },
    ],
  },
  {
    key: 'badge',
    label: translate('cardStickers.t263'),
    stickers: [
      { code: '1f948', name: translate('cardStickers.t264') },
      { code: '1f949', name: translate('cardStickers.t265') },
      { code: '1f3c5', name: translate('cardStickers.t266') },
      { code: '1f39f', name: translate('cardStickers.t267') },
      { code: '1f4dc', name: translate('cardStickers.t268') },
      { code: '1f9fe', name: translate('cardStickers.t269') },
      { code: '1f4e7', name: translate('cardStickers.t270') },
      { code: '1f4ee', name: translate('cardStickers.t271') },
      { code: '1f5ff', name: translate('cardStickers.t272') },
    ],
  },
  {
    key: 'weather',
    label: translate('cardStickers.t273'),
    stickers: [
      { code: '1f327', name: translate('cardStickers.t274') },
      { code: '1f328', name: translate('cardStickers.t275') },
      { code: '26c8', name: translate('cardStickers.t276') },
      { code: '1f32b', name: translate('cardStickers.t277') },
      { code: '1f321', name: translate('cardStickers.t278') },
      { code: '2602', name: translate('cardStickers.t279') },
      { code: '1f30d', name: translate('cardStickers.t280') },
      { code: '1f30c', name: translate('cardStickers.t281') },
      { code: '1f307', name: translate('cardStickers.t282') },
      { code: '1f303', name: translate('cardStickers.t283') },
    ],
  },
]
